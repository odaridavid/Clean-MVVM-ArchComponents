...
val useCasesModule = module {
    ...
    single(named("delete_favorite")) { provideDeleteFavoriteUseCase(get()) }
...
fun provideDeleteFavoriteUseCase(favoritesRepository: IFavoritesRepository): DeleteFavoriteBaseUseCase {

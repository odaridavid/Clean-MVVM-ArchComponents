...
internal data class FavoritePresentation(
    ...
    val speciePresentation: List<com.k0d4black.theforce.feature.character.details.SpeciePresentation>,
    val films: List<com.k0d4black.theforce.feature.character.details.FilmPresentation>
) : Parcelable